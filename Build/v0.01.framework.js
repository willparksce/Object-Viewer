...
var ASM_CONSTS = {
  3780652: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3780707: ($0) => { performance.now = function() { return $0; }; },  
 3780755: ($0) => { performance.now = function() { return $0; }; },  
 3780803: () => { performance.now = Module['emscripten_get_now_backup']; }
};
