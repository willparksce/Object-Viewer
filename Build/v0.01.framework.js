...
var ASM_CONSTS = {
  3780780: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3780835: ($0) => { performance.now = function() { return $0; }; },  
 3780883: ($0) => { performance.now = function() { return $0; }; },  
 3780931: () => { performance.now = Module['emscripten_get_now_backup']; }
};
