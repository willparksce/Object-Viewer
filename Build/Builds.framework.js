...
var ASM_CONSTS = {
  3767076: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3767131: ($0) => { performance.now = function() { return $0; }; },  
 3767179: ($0) => { performance.now = function() { return $0; }; },  
 3767227: () => { performance.now = Module['emscripten_get_now_backup']; }
};
